...
class HoltWinters:
    ...
    def plotHoltWinters(self, series, plot_intervals=False, plot_anomalies=False):
        ...
        if plot_anomalies:
            ...
            anomalies[series.values < self.LowerBond[:len(series)]] = \
                series.values[series.values < self.LowerBond[:len(series)]]
            anomalies[series.values > self.UpperBond[:len(series)]] = \
                series.values[series.values > self.UpperBond[:len(series)]]
